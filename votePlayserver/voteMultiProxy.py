    ...
    try:
        ...
        if r2.status_code == 200:
            ...
            if status['success']:
                ...
                a_file.close()
                # print(json_object)
                print(colored("[INFO] SUCCESS : ", 'blue'),colored(json_object['success'], 'blue'))
...
if __name__ == "__main__":
    ...
    while True:
        ...
        arr = np.concatenate((proxys1, proxys4))
        start_time = time.time()
        download_all_sites(arr,configList)
        duration = time.time() - start_time
        print(f"Call {len(arr)} in {duration} seconds")
