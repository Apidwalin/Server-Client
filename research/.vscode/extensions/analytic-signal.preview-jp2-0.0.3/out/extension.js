...
function activate(context) {
    ...
    context.subscriptions.push(vscode.commands.registerCommand('preview-jp2.zoomIn', () => {
        var _a;
        (_a = previewManager.activePreview) === null || _a === void 0 ? void 0 : _a.zoomIn();
    }));
    context.subscriptions.push(vscode.commands.registerCommand('preview-jp2.zoomOut', () => {
        var _a;
