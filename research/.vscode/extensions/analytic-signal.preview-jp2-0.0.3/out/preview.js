...
class PreviewManager {
    ...
    setPreviewActiveContext(value) {
        vscode.commands.executeCommand('setContext', 'preview-jp2Focus', value);
    }
}
exports.PreviewManager = PreviewManager;
PreviewManager.viewType = 'analyticsignal.preview-jp2';
...
<head>
	...
	<meta id="preview-jp2-settings" data-settings="${escapeAttribute(JSON.stringify(settings))}">

	<!-- add script resources for j2k.js -->
    <script src="${escapeAttribute(this.extensionResource('/media/openjpeg.js'))}" nonce="${nonce}"></script>
</head>
