...
class Connection extends dbgp_1.DbgpConnection {
    ...
    sendFeatureGetCommand(feature) {
        return __awaiter(this, void 0, void 0, function* () {
            return new FeatureGetResponse(yield this._enqueueCommand('feature_get', `-n ${feature}`), this);
        });
    }
    /**
     ...
     */
    sendBreakpointGetCommand(breakpoint) {
        return __awaiter(this, void 0, void 0, function* () {
            let breakpointId;
            ...
            return new BreakpointGetResponse(yield this._enqueueCommand('breakpoint_get', `-d ${breakpointId}`), this);
        });
    }
    ...
    sendBreakpointRemoveCommand(breakpoint) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new Response(yield this._enqueueCommand('breakpoint_remove', `-d ${breakpointId}`), this);
        });
    }
    // ----------------------------- continuation ---------------------------------
    /** sends a run command */
